...
const HELP_SECTIONS = [
  ...
  { title: "PLAYBACK", body: "Drone sustains the root note. DRONE OCT drops it 1-3 octaves. Play steps through the scale in Arpeggio or Melody mode. Melody uses a weighted random walk with rhythm variation and octave leaps. CHORD layers multiple scale tones per step - power (root+5th), sus2, triad, 7th, or all notes at once." },
